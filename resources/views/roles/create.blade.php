...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4 col-md-6"><a href="{{ route('role.index') }}" class="text-muted fw-light">Roles /</a> Create</h4>
    <!-- Basic Layout -->
    <div class="card mb-4">
                                       ...
                                       <div class="row" >
                                            @foreach ($permissionList as $permission)
                                                <div class="form-check mt-3 col-md-3">
                                                    <input class="form-check-input" name="permissions[]" type="checkbox" value="{{ $permission->name }}" id="{{ $permission->name }}" {{ (!empty(old('permissions')) && in_array($permission->name, old('permissions'))) ? 'checked' : ''  }} />
