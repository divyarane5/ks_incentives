                    ...
                    <div class="card border-none">
                        ...
                        <article class="card-body">
                            ...
                            <div class="bg-blue p-2 mt-4 mb-4">
                                    <h4 class="card-title text-left text-white">Your Contact Details</h4>
                                </div> <hr>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="hidden" name="referrals" id="referrals" value="referrals" class="form-control" placeholder="Name">
                            ...
                            <div class="bg-blue p-2">
                                    <h4 class="card-title text-left text-white">Refer Your Friends & Family Members</h4>
                            </div> <hr>
                                    ...
                                    <thead class="bg-light">
                                      ...
                                      <tbody>
                                        <tr>
                                            ...
                                            <td><input type="text" name="client_name1" id="client_name1" class="form-control" placeholder="Client Name"/></td>
                                            <td><input type="text" name="client_mobile1" id="client_mobile1" class="form-control" placeholder="Mobile No" /></td>
                                            <td><input type="email" name="client_email1" id="client_email1" class="form-control" placeholder="Email Id"/></td>
                                        </tr>
                                          <tr class="bg-light">
                                            <th scope="row" class="text-center">2</th>
                                            <td><input type="text" name="client_name2" id="client_name2" class="form-control" placeholder="Client Name"/></td>
                                            <td><input type="text" name="client_mobile2" id="client_mobile2" class="form-control" placeholder="Mobile No" /></td>
                                            <td><input type="email" name="client_email2" id="client_email2" class="form-control" placeholder="Email Id"/></td>
                                          </tr>
                                          <tr>
                                            <th scope="row" class="text-center">3</th>
                                            <td><input type="text" name="client_name3" id="client_name3" class="form-control" placeholder="Client Name"/></td>
                                            <td><input type="text" name="client_mobile3" id="client_mobile3" class="form-control" placeholder="Mobile No" /></td>
                                            <td><input type="email" name="client_email3" id="client_email3" class="form-control" placeholder="Email Id"/></td>
                                          </tr>
                                          <tr class="bg-light">
                                            <th scope="row" class="text-center">4</th>
                                            <td><input type="text" name="client_name4" id="client_name4" class="form-control" placeholder="Client Name"/></td>
                                            <td><input type="text" name="client_mobile4" id="client_mobile4" class="form-control" placeholder="Mobile No" /></td>
                                            <td><input type="email" name="client_email4" id="client_email4" class="form-control" placeholder="Email Id"/></td>
                                          </tr>
                                          <tr>
                                            <th scope="row" class="text-center">5</th>
                                            <td><input type="text" name="client_name5" id="client_name5" class="form-control" placeholder="Client Name"/></td>
                                            <td><input type="text" name="client_mobile5" id="client_mobile5" class="form-control" placeholder="Mobile No" /></td>
                                            <td><input type="email" name="client_email5" id="client_email5" class="form-control" placeholder="Email Id"/></td>
                                          </tr>
                                      </tbody>
                                </table>
        ...
        //console.log("ff");
            ...
            if(valid) {
                ...
                jQuery.ajax({
                    ...
                    $("#mobileno").val()+'&ip='+
                    $("#ip").val()+'&client_name1='+
                    $("#client_name1").val()+'&client_mobile1='+
                    $("#client_mobile1").val()+'&client_email1='+
                    $("#client_email1").val()+'&client_name2='+
                    $("#client_name2").val()+'&client_mobile2='+
                    $("#client_mobile2").val()+'&client_email2='+
                    $("#client_email2").val()+'&client_name3='+
                    $("#client_name3").val()+'&client_mobile3='+
                    $("#client_mobile3").val()+'&client_email3='+
                    $("#client_email3").val()+'&client_name4='+
                    $("#client_name4").val()+'&client_mobile4='+
                    $("#client_mobile4").val()+'&client_email4='+
                    $("#client_email4").val()+'&client_name5='+
                    $("#client_name5").val()+'&client_mobile5='+
                    $("#client_mobile5").val()+'&client_email5='+
                    $("#client_email5").val()+'&username='+
                    $("#username").val()+'&usermobile='+
                    $("#usermobile").val()+'&referrals='+
                    $("#referrals").val(),
                    type: "POST", 
                    headers: {
