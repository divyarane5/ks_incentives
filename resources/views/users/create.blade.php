...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><a href="{{ route('users.index') }}" class="text-muted fw-light">Users/</a> Add User</h4>
    <!-- Basic Layout -->
    <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" name="name" class="form-control" id="name" value="{{ old('name') }}" placeholder="Name" @error('name') autofocus @enderror required />
                        @error('name')
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" name="employee_code" class="form-control" id="employee_code" value="{{ old('employee_code') }}" placeholder="Employee Code" @error('employee_code') autofocus @enderror required />
                        @error('employee_code')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" name="email" class="form-control" id="email" value="{{ old('email') }}" autocomplete="new-email" placeholder="Email" @error('email') autofocus @enderror required/>
                        @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="mb-3 col-md-6">
                        <label class="form-label" for="password">Password<span class="start-mark">*</span></label>
                        <input type="password" name="password" class="form-control" id="password" value="{{ old('password') }}" autocomplete="new-password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" @error('password') autofocus @enderror required />
                        @error('password')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <select id="reporting_user_id" name="reporting_user_id" class="form-select" @error('reporting_user_id') autofocus @enderror>
                            ...
                            @if (!empty($reportingUsers))
                                @foreach ($reportingUsers as $key => $reportingUser)
                                    <option value="{{ $reportingUser->id }}" {{ ($reportingUser->id == old('reporting_user_id') ? 'selected' : '') }}>{{ $reportingUser->name }}</option>
                                @endforeach
                            @endif
                        </select>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="date" value="{{ old('joining_date') }}" id="joining_date" name="joining_date" @error('joining_date') autofocus @enderror required />
                        @error('joining_date')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
