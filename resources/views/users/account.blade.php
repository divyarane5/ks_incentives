                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" id="email" name="email" value="{{ (old('email') != "") ? old('email') : auth()->user()->email }}" placeholder="john.doe@example.com" @error('email') autofocus @enderror />
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
