...
class Client extends Model
{
    ...
    public function getAllData($id)
	{
	    return DB::table('clients')
                    ->select('users.name as u_name','users.id as u_id','designations.name as d_name','clients.client_name','clients.client_email','clients.sales_person','clients.created_by','templates.content','clients.id','users.mobile','clients.subject_name')
